...
github_repository = "astatine"
github_url = f"https://github.com/{github_username}/{github_repository}"

rst_prolog = f""".. |pkgname| replace:: astatine
.. |pkgname2| replace:: ``astatine``
...
documentation_summary = "Some handy helper functions for Python's AST module."
